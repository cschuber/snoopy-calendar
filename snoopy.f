C     ******************************************************************
C     PROGRAMMER, SAM E. ROBBINS                   FEBUARY 1,1975
C     ******************************************************************
C     *                                                                *
...
C     ******************************************************************
     ...
     1          CAL(60,22)
      ...
      OPEN (5)
      OPEN (6,FORM='print')
      READ (5,1) (((AMONTH(I,J,K),K=1,13),J=1,7),I=1,12)
      READ (5,2) (ANAM(I),I=1,22)
      READ (5,3) (((ANUM(I,J,K),J=1,10),K=1,5),I=1,2)
      READ (5,4) (NODS(I),I=1,12)
      READ (5,1) BLANK,ONE,ALIN1,ALIN2,ALIN3,ALIN4
      READ (5,4) MF,IYR,MTHLST,IYRLST,LNSW
      ISET=25
      DO 10 I=1,60
      DO 10 J=1,22
10    CAL(I,J)= BLANK
...
6     FORMAT (/,30X, '
     2                      ')
      ...
      COMMON I
C     DATA PLUS,AMPSAN/1H+,1H+/
11    N=0
10    I=I+1
      IF (I-25) 14,14,13
13    I=1
      READ (5,1) (KRD1(K),CRD2(K),K=1,25)
14    M=N+1
      IF (KRD1(I)) 15,10,16
...
C31   WRITE OUTPUT TAPE 1,2, (ALIN(J),J=1,132)
      GO TO 11
33    READ (5,5) (ALIN(J),J=1,13),ICHK
      WRITE (6,7) (ALIN(J),J=1,13)
      IF (ICHK+2) 77,35,33
44    READ (5,3) (ALIN(J),J=1,22),ICHK
      WRITE (6,4) (ALIN(J),J=1,22)
      IF (ICHK+2) 77,35,44
55    READ (5,6) (ALIN(J),J=1,22),ICHK
      WRITE (6,4) (ALIN(J),J=1,22)
      IF (ICHK+2) 77,35,55
77    I=25
      GO TO 11
